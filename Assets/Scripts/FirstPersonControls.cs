...
public class FirstPersonControls : MonoBehaviour
{
    ...
    void CheckFlashlightHit()
    {
        if (flashlightOn)
        {
            ...
            hits = Physics.SphereCastAll(flashlight.transform.position, 0.5f, flashlight.transform.forward, 10, shadows);
            ...
            foreach (RaycastHit hit in hits)
            {
                ...
                if (Vector3.Dot(flashlight.transform.forward, toHit) > Mathf.Cos(Mathf.Deg2Rad * (flashlight.spotAngle / 1.5f)))
                {
